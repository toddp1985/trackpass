...
function generateCaption(c) {
  const tier = c.partner ? '⭐ Partner course — 1 free round/yr' : 'Green fee reimbursed up to $50/round with TrackPass';
  const templates = [
